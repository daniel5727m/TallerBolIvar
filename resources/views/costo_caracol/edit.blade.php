    ...
    color: rgb(105, 104, 104);
        ...
        <div class="card" style="width: 100rem;">
                <div class="card-body">
                    ...
                    <h2><b> Editar costo Caracol #{{ $costo_caracol->id }}</b> </h2>
                    <div class="card-body">
                        <a href="{{ url('/costo_caracol') }}" title="Atras"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Atras</button></a>
                        <br />
                        <br />
