            ...
            <div class="col-md-6" style="margin-top: -150px;">
                <div class="card" style="margin-top: -5px;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/pruebas') }}/{{ $solicitude->id }}" title="Go to Turn" class="btn btn-danger btn-sm" style="width:140px">
                        ...
                        <div>
                            <div class="table-responsive" style="margin-bottom: -91px; margin-top: -10px;">
                                ...
                                <br>
                                <br>
                                    {{-- <iframe id="iframe_doblez" src="http://localhost/tallerBolivar3/resources/views/solicitudes/flechas.blade.php" width="500" height="400" frameborder="2" style="width: 100%;"></iframe> --}}
                                </div>
                                    @else
