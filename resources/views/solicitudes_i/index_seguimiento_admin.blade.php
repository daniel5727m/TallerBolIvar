...
@else 
    ...
    color: rgb(105, 104, 104);
        ...
        <div class="card" style="width: 100rem;">
                <div class="card-body">
                       <h2 ><b> Administrar solicitudes</b></h2>
                        <br><br>
                                ...
                                @foreach($solicitudes as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/solicitudes_seguimiento_admin/' . $item->id) }}" title="Ver solicitud"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                                            @endif
                                            <a href="{{ url('/solicitudes/' . $item->id . '/edit') }}" title="Editar solicitud"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
